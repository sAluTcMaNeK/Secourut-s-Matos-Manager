...
<div class="white-box">
    ...
    <div
        ...
        <div>
            <a href="gestion_sac.php" style="color: #666; text-decoration: none; font-size: 14px;">⬅ Changer de
                stockage</a>
    ...
    <?php if ($peut_editer): ?>
        <div class="form-container">
            ...
            <form action="gestion_sac.php?lieu_id=<?php echo $lieu_id; ?>" method="POST" class="form-group-inline">
